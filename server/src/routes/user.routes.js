 ...
 * 更新用户信息
 */
router.put('/:id', roleMiddleware('admin', 'super_admin'), validateIdParam, validateUser, sanitizeBody, updateUser)

/**
 * PUT /api/users/:id/status
 * 更新用户状态（激活/禁用）
 */
router.put('/:id/status', roleMiddleware('admin', 'super_admin'), validateIdParam, validateUserStatus, updateUserStatus)

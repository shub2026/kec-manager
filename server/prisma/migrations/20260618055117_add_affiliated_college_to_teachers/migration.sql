...
INSERT INTO "new_teachers" ("birth_date", "created_at", "default_weekly_hours", "gender", "id", "name", "personnel_type", "qualification_type", "sort_order", "updated_at") SELECT "birth_date", "created_at", "default_weekly_hours", "gender", "id", "name", "personnel_type", "qualification_type", "sort_order", "updated_at" FROM "teachers";
DROP TABLE "teachers";
